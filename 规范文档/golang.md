## Go 代码开发规范
在Go 项目开发中，一个好的编码规范可以极大的提高代码质量。为了帮你节省时间和精力，这里我整理了一份清晰、可直接套用的 Go 编码规范。
这份编码规范中包含代码风格、命名规范、注释规范、类型、控制结构、函数、GOPATH 设置规范、依赖管理和最佳实践九类规范。
参考文档: https://github.com/marmotedu/miniblog/blob/master/docs/devel/zh-CN/conversions/go_code.md
...
- 变量尽可能全拼，如 userId、userPhone 等，简写不能提高代码阅读效率
- 特有名词时，需要遵循以下规则：
